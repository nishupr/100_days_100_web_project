...
function fillTable(searchTerm = "") {
    ...
    const data = [
        ...
        ["Day 117", "Buttons UI Page", "./public/ButtonsUIPage/index.html"],
        ["Day 118", "Color Palette Generator", "./public/color-palette-generator/index.html"],
        ["Day 119", "Color Picker", "./public/color_picker/index.html"],
        ["Day 120", "Countdown Timer", "./public/CountDown Timer/index.html"]
    ];
