...
const PROJECT_DATA = [
  ...
  [
    ...
    "./public/github-repository-analyser/index.html",
    "github javascript",
    "intermediate",
  ],
];
    ...
    const matchesFilter =
      ...
      (() => {
        ...
        if (activeFilter === "clone") {
          return (
            nameStr.includes("clone") ||
            urlStr.includes("clone") ||
            urlStr.includes("cloning")
          );
        }
        if (activeFilter === "tool") {
          return (
            tagStr.includes("tool") ||
            tagStr.includes("todo") ||
            tagStr.includes("calculator") ||
            tagStr.includes("weather") ||
            nameStr.includes("tracker") ||
            nameStr.includes("generator") ||
            nameStr.includes("converter") ||
            nameStr.includes("validator") ||
            nameStr.includes("saver") ||
            nameStr.includes("utils")
          );
        }
        if (activeFilter === "ui") {
          return (
            ...
            tagStr.includes("animation") ||
            nameStr.includes("animation") ||
            nameStr.includes("cursor") ||
            nameStr.includes("effect") ||
            nameStr.includes("slider")
          );
        }
        if (activeFilter === "api") {
          return (
            tagStr.includes("api") ||
            tagStr.includes("weather") ||
            nameStr.includes("api") ||
            nameStr.includes("fetch")
          );
        }
        return false;
      })();
